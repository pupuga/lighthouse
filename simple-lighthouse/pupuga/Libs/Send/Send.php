...
class Send
{
    ...
    public function mail()
    {
        ...
        foreach ($this->parameters['to'] as $to) {
            $result[] = wp_mail($to, $this->parameters['subject'], $this->parameters['message'], $this->parameters['headers'], $this->parameters['attachment']);
        }
    ...
    public function setAttachmentMail($attachment)
    {
        $this->parameters['attachment'] = $attachment;
    }
